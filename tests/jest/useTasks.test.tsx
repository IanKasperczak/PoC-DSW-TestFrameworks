/**
 * Pruebas del hook useTasks.
 * La primera parte usa la red simulada real (MSW); la segunda reemplaza el
 * módulo completo con jest.mock() para verificar el manejo de errores y las
 * interacciones, aprovechando el izado automático de las simulaciones.
 */
